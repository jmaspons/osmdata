...
//' 
//' @noRd 
void osm_df::get_osm_ways (Rcpp::List &wayList, Rcpp::DataFrame &kv_df,
...
//' 
//' @noRd 
void osm_df::get_osm_nodes (Rcpp::List &ptList, Rcpp::DataFrame &kv_df,
...
Rcpp::List rcpp_osmdata_df (const std::string& st)
{
    ...
    Rcpp::List tempList = osm_df::get_osm_relations (rels, nodes, ways, unique_vals,
            bbox, crs);
    ...
    osm_df::get_osm_ways (polyList, kv_df_polys, poly_ways, ways, nodes, unique_vals,
            "POLYGON", bbox, crs);

    Rcpp::List lineList (non_poly_ways.size ());
    Rcpp::DataFrame kv_df_lines;
    osm_df::get_osm_ways (lineList, kv_df_lines, non_poly_ways, ways, nodes, unique_vals,
            "LINESTRING", bbox, crs);
    ...
    osm_df::get_osm_nodes (pointList, kv_df_points, nodes, unique_vals, bbox, crs);
